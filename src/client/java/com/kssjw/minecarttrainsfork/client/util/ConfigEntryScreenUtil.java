            ...
            ButtonWidget.builder(
                ...
                button -> {
                    if (isMultiplayerWorld) {
                        ...
                        this.client.setScreen(AutoConfig.getConfigScreen(ConfigValue.class, this).get());
                    }
                }
            )
            ...
            ButtonWidget.builder(
                ...
                button -> {
                    if (ClientLoadManager.isAPIFound()) {
                        this.client.setScreen(AutoConfig.getConfigScreen(ClientConfigValue.class, this).get());
                    } else {
