            ...
            Button.builder(
                ...
                button -> {
                    if (isMultiplayerWorld) {
                        ...
                        this.minecraft.setScreen(AutoConfig.getConfigScreen(ConfigValue.class, this).get());
                    }
                }
            )
            ...
            Button.builder(
                ...
                button -> {
                    if (ClientLoadManager.isAPIFound()) {
                        this.minecraft.setScreen(AutoConfig.getConfigScreen(ClientConfigValue.class, this).get());
                    } else {
