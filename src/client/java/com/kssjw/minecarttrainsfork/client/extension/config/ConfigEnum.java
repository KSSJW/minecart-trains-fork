...
public class ConfigEnum {
    ...
    public enum ParticleOption {
        ...
        trial_spawner_detected_player(ParticleTypes.TRIAL_SPAWNER_DETECTION),
        trial_spawner_detected_player_ominous(ParticleTypes.TRIAL_SPAWNER_DETECTION_OMINOUS),
