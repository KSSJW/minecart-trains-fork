...
public class LinkUtil {
    ...
    public static @Nullable AbstractMinecartEntity getChainedParent(AbstractMinecartEntity entity, IChainableUtil icu) {
        Entity target = entity.getWorld() instanceof ServerWorld sWorld && icu.getParentUUID() != null ? sWorld.getEntity(icu.getParentUUID()) : entity.getWorld().getEntityById(icu.getParentClientID());
    ...
    public static @Nullable AbstractMinecartEntity getChainedChild(AbstractMinecartEntity entity, IChainableUtil icu) {
        Entity target = entity.getWorld() instanceof ServerWorld sWorld && icu.getChildUUID() != null ? sWorld.getEntity(icu.getChildUUID()) : entity.getWorld().getEntityById(icu.getChildClientID());
        return target instanceof AbstractMinecartEntity minecart ? minecart : null;
    }
