...
public class EventManager {
    ...
    private static ActionResult link(ItemStack stack, AbstractMinecartEntity cart, PlayerEntity player, Hand hand, World world, DataComponentType<UUID> PARENT_ID) {
        if (
            player.isSneaking()
    ...
    public static ActionResult init(Entity entity, PlayerEntity player, Hand hand, World world, DataComponentType<UUID> PARENT_ID) {
