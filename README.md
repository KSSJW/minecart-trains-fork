...
- The client can customize the connection display.
...
- The client can change the rendering effects.

![Config](https://raw.githubusercontent.com/KSSJW/minecart-trains-fork/refs/heads/dev/images/Config.png)